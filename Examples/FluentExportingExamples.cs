...
{
    public static class FluentExportingExamples
    {
        ...
        public static async Task ExportGenerationVisualizationAsync()
        {
            ...
            string directory = @"d:\maze-frames";
            ...
            {
                using var fs = File.Create(Path.Combine(directory, $"{i++:000}.svg"));
                using var svgWriter = new SvgWriter(fs);
        ...
        public static async Task ExportOriginShiftVisualizationAsync()
        {
            ...
            string directory = @"d:\origin-shift-maze";
            // Create a directory for SVG frames
            Directory.CreateDirectory(directory);
