...
namespace Labyrinthian.Svg
{
    public readonly struct SvgColor
    {
        ...
        public static SvgColor White => new SvgColor(0xFF, 0xFF, 0xFF);
        public static SvgColor Gray => new SvgColor(0x80, 0x80, 0x80);
        public static SvgColor Grey => new SvgColor(0x80, 0x80, 0x80);
        public static SvgColor Black => new SvgColor(0x00, 0x00, 0x00);
        public static SvgColor Red => new SvgColor(0xFF, 0, 0x00);
        public static SvgColor Green => new SvgColor(0x00, 0xFF, 0x00);
        public static SvgColor Blue => new SvgColor(0x00, 0x00, 0xFF);
        public static SvgColor Orange => new SvgColor(0xFF, 0xA5, 0x00);
        public static SvgColor Yellow => new SvgColor(0xFF, 0xFF, 0x00);
        public static SvgColor Purple => new SvgColor(0x80, 0x00, 0x80);
        public static SvgColor Magenta => new SvgColor(0xFF, 0x00, 0xFF);
        public static SvgColor Cyan => new SvgColor(0x00, 0xFF, 0xFF);
        #endregion
